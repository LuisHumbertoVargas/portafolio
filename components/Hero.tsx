    ...
    <div className='pb-20 pt-36'>
      ...
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          <i className='tracking-widest text-[10px] mt-2 text-center text-blue-100'>
            Steve Jobs
          </i>
          <TextGenerateEffect
            className='text-center text-[45px] md:text-5xl lg:text-6xl'
            words='Transform Concepts into Valuable User Experiences'
          />

          <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
            Hi, I&apos;m Luis, a software engineer and your{' '}
            <b className='text-purple'>best collaborator.</b>
          </p>
